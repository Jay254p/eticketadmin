...
class ReportDownloadController extends Controller
{
    ...
    public function downloadAppeals()
    {
        $data =Transaction::all();

        $csvData = $this->generateCsvDataAppeals($data);
        $currentTime = date('Y-m-d H:i:s');
        $fileName = 'Appeals_Data.csv';
    ...
    private function generateCsvDataAppeals($data)
    {
        $output = fopen('php://temp', 'w');
        fputcsv($output, [
            'TicketId',
